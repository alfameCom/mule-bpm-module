...
Awaiting events is really useful for Munit tests. However, event subscriptions are production grade implementation, which can be used inside actual Mule BPM Applications.
