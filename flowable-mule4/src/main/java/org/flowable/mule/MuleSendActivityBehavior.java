            ...
            if( queue != null ) {
                try {
                    ...
                    if( resultVariableValue != null && response.getValue() != null ) {
                    	...
                    	for ( Map.Entry< String, TypedValue< Serializable > > variableToUpdate : response.getVariablesToUpdate().entrySet() ) {
                            logger.trace( "<<<<< " + execution.getProcessDefinitionId() + " / " + execution.getCurrentActivityId() + ": " + execution.getProcessInstanceId() + ": variable " + variableToUpdate.getKey() + "=" + variableToUpdate.getValue() );
                            logger.debug( "<<<<< " + execution.getProcessDefinitionId() + " / " + execution.getCurrentActivityId() + ": " + execution.getProcessInstanceId() + ": variable " + variableToUpdate.getKey() + "=" + variableToUpdate.getValue().getValue() );
                            execution.setVariable( variableToUpdate.getKey(), variableToUpdate.getValue().getValue() );
                    	}
                        ...
                        logger.debug( "<<<<< " + execution.getProcessDefinitionId() + " / " + execution.getCurrentActivityId() + ": " + execution.getProcessInstanceId() + ": variable " + resultVariableValue + "=" + response.getValue().getValue() );
                        execution.setVariable( resultVariableValue, response.getValue().getValue() );
                    }
