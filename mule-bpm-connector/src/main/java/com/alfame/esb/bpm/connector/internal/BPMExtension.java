...
import com.alfame.esb.bpm.connector.api.config.BPMAsyncExecutor;
import com.alfame.esb.bpm.connector.api.config.BPMClasspathDefinition;
import com.alfame.esb.bpm.connector.api.config.BPMDataSource;
import com.alfame.esb.bpm.connector.api.config.BPMDataSourceReference;
import com.alfame.esb.bpm.connector.api.config.BPMDefinition;
import com.alfame.esb.bpm.connector.api.config.BPMGenericDataSource;
import com.alfame.esb.bpm.connector.api.config.BPMStreamDefinition;
import com.alfame.esb.bpm.connector.api.config.BPMTenant;
